...
def search():
    if request.method == 'POST':
        ...
        conn = mysql.connector.connect(host="localhost", port="3306", user="root", password="55889528",
                                       database="users")
        cursor = conn.cursor()
...
def details_page():
    ...
    connection = mysql.connector.connect(host="localhost", port="3306", user="root", password="55889528",
                                         database="users")
...
def login():
    if request.method == 'POST':
        ...
        conn = mysql.connector.connect(host="localhost", port="3306", user="sou", password="55889528", database="users")
...
def member():
    # Connexion à la base de données
    connection = mysql.connector.connect(host="localhost", port="3306", user="root", password="55889528", database="users")
    cursor = connection.cursor()
...
def ajouterm():
    if request.method == 'POST':  # Check if the form is submitted
        ...
        password = request.form['Password']  # Get the value of the 'Password' field from the submitted form
        # Connect to the database
        conn = mysql.connector.connect(host="localhost", port="3306", user="root", password="55889528", database="users")
        c = conn.cursor()
